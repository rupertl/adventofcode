...
hidden if the `aoc2017_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `aoc2017_DEVELOPER_MODE` to the configure
...
Runs the executable target `aoc2017_exe`.
